...
const ONLINE_USERS = [
  { username: 'angel', badge: 'MANAGER', avatar: '😇', status: 'online' },
  { username: 'pretty', badge: 'MANAGER', avatar: '💄', status: 'online' },
  { username: 'qix', badge: 'BUG HUNTER', avatar: '🐛', status: 'online' },
  { username: 'mmm', badge: 'VERIFIED', avatar: '✅', status: 'online' },
  { username: 'cat', badge: 'PREMIUM', avatar: '🐱', status: 'online' },
  { username: 'celebrity', badge: 'LINKED', avatar: '⭐', status: 'online' },
  { username: 'ew', badge: 'LINKED', avatar: '😠', status: 'online' },
  { username: 'greed', badge: '', avatar: '🤑', status: 'online' },
  { username: 'h', badge: '', avatar: '🤔', status: 'online' },
  { username: 'jeffery', badge: 'LINKED', avatar: '👔', status: 'online' },
  { username: 'lose', badge: '', avatar: '😢', status: 'online' },
  { username: 'oh', badge: 'LINKED', avatar: '😮', status: 'online' },
  { username: 'omg', badge: 'LINKED', avatar: '😲', status: 'online' },
  { username: 'princess', badge: '', avatar: '👑', status: 'online' },
  { username: 'py', badge: '', avatar: '💜', status: 'online' },
  { username: 'tero...', badge: 'LINKED', avatar: '🔥', status: 'online' },
  { username: 'playtoy', badge: '', avatar: '🎮', status: 'online' },
  { username: 'aa', badge: 'LINKED', avatar: '🅰️', status: 'online' },
];
    ...
    <div className="flex h-[calc(100vh-80px)] pt-20 bg-dark">
      ...
      <div className="flex-1 flex flex-col bg-dark border-r border-secondary">
        ...
        <div className="flex-1 overflow-y-auto p-6 space-y-2">
          {messages.map((msg) => (
            <div key={msg.id} className="group hover:bg-secondary/30 px-4 py-1 rounded transition">
              <div className="flex gap-3">
                {/* Avatar */}
                <div className="w-10 h-10 bg-accent rounded-full flex items-center justify-center text-lg flex-shrink-0">
                  {msg.avatar}
                </div>
              ...
              <div className="space-y-2">
                {onlineUsers
                  ...
                  .map((user) => (
                    <div
                      key={user.username}
                      className="flex items-center gap-2 px-3 py-2 rounded hover:bg-accent/20 cursor-pointer transition group"
                    >
                      ...
                      <span className="text-xs bg-accent text-dark px-2 py-1 rounded font-bold group-hover:block hidden">
                        {user.badge}
                      </span>
                    </div>
                  ))}
              ...
              <div className="space-y-2">
                {onlineUsers
                  ...
                  .map((user) => (
                    <div
                      key={user.username}
                      className="flex items-center gap-2 px-3 py-2 rounded hover:bg-accent/20 cursor-pointer transition"
                    >
                      <div className="w-8 h-8 bg-accent rounded-full flex items-center justify-center text-sm">
                        {user.avatar}
                      </div>
